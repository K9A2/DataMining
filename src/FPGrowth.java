...
class FPGrowth {
    ...
    public List<StringBuilder> FPGrowth(List<List<String>> transactions, List<String> postPattern, List<StringBuilder> fpOutput)
    {
        //构建头项表
        ...
        for(TNode head : headerTable)
        {
            ...
            //每个头项表节点重复上述所有操作，递归
            FPGrowth(newTransaction, newPostPattern, fpOutput);
        }
        return null;
    }
